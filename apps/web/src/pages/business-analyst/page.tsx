type ResourceLink = {
  ...
  description: string;
  url: string;
  category: 'Core Systems' | 'Analysis & Reporting' | 'Documentation & Process' | 'Project & Collaboration';
...
const categoryDescriptions: Record<ResourceLink['category'], string> = {
  ...
  'Analysis & Reporting': 'Resources for reviewing trends, metrics, data definitions, and business logic.',
  'Documentation & Process': 'Templates, guides, and process materials for structured execution.',
  'Project & Collaboration': 'Planning, communication, and coordination resources for cross-team work.',
};
